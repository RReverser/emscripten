...
export function $runAndAbortIfError(func) {
  try {
    return func();
  } catch (e) {
    abort(e);
...
#if ASYNCIFY
export const $Asyncify__deps = ['$runAndAbortIfError', '$callUserCallback', '$sigToWasmTypes',
#if !MINIMAL_RUNTIME
...
export function emscripten_sleep(ms) {
...
export const emscripten_wget_data__deps = ['$asyncLoad', 'malloc'];
export const emscripten_wget_data__async = true;
...
export const emscripten_scan_registers__deps = ['$safeSetTimeout'];
export const emscripten_scan_registers__async = true;
...
export const emscripten_lazy_load_code__async = true;
export const emscripten_lazy_load_code = () => Asyncify.handleSleep((wakeUp) => {
...
export const _load_secondary_module__sig = 'v';
export async function _load_secondary_module() {
...
export const $Fibers__deps = ['$Asyncify', 'emscripten_stack_set_limits', '$stackRestore'];
export const $Fibers = {
  nextFiber: 0,
...
export const emscripten_fiber_swap__deps = ["$Asyncify", "$Fibers", '$stackSave'];
export const emscripten_fiber_swap__async = true;
