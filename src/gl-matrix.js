(() => {
   ...
   */
  vec3.dot = (vec, vec2) => vec[0] * vec2[0] + vec[1] * vec2[1] + vec[2] * vec2[2];;
   ...
   */
  vec3.str = (vec) => '[' + vec[0] + ', ' + vec[1] + ', ' + vec[2] + ']';;
   ...
   */
  mat3.str = (mat) => '[' + mat[0] + ', ' + mat[1] + ', ' + mat[2] +
      ', ' + mat[3] + ', ' + mat[4] + ', ' + mat[5] +
      ', ' + mat[6] + ', ' + mat[7] + ', ' + mat[8] + ']';;
   ...
   * _returns {mat4} dest if specified, a new mat4 otherwise
   */
  mat4.fromRotationTranslation = (quat, vec, dest) => {
    if (!dest) { dest = mat4.create(); }
   ...
   */
  mat4.str = (mat) => '[' + mat[0] + ', ' + mat[1] + ', ' + mat[2] + ', ' + mat[3] +
   ...
   */
  quat4.dot = (quat, quat2) => quat[0]*quat2[0] + quat[1]*quat2[1] + quat[2]*quat2[2] + quat[3]*quat2[3];;
   ...
   */
  quat4.str = (quat) => '[' + quat[0] + ', ' + quat[1] + ', ' + quat[2] + ', ' + quat[3] + ']';;
