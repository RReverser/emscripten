...
var z = fleefl();
var yy = 1,
  zz = fleefl(); // but zz must remain due to the side effects in the value
var obj = {
  x: 5
};
var keeperObj = {
...
function emulate() {
  _glCreateShader = function _glCreateShader(shaderType) {
    // the name here is just for show in stack traces!
